...
const productsApi = api.injectEndpoints({
  endpoints: (build) => ({
    ...
    getProductsBlush: build.query<Product[], void>({
      query: () => ({
    ...
    getProductsBronzer: build.query<Product[], void>({
      query: () => ({
    ...
    getProductsEyeLiner: build.query<Product[], void>({
      query: () => ({
    ...
    getProductsEyeshadow: build.query<Product[], void>({
      query: () => ({
    ...
    getProductsFoundation: build.query<Product[], void>({
      query: () => ({
    ...
    getProductsLipliner: build.query<Product[], void>({
      query: () => ({
    ...
    getProductsMascara: build.query<Product[], void>({
      query: () => ({
